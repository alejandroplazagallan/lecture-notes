...
-\Delta u=f\ &\text{ in }&&\ \mathbb R_+^n,\tag{P}\label{Poisson_halfspace}\\
u=0\ &\text{ on }&&\ \partial\mathbb R_+^n=\{y_n=0\}.\tag{BC$_0$}\label{BC_halfspace}
\end{empheq}
...
\begin{empheq}[left=\empheqlbrace]{alignat=2}
-\Delta u=f\ &\text{ in }&&\ \mathbb R_+^n,\tag{P}\label{Poisson_nonzero}\\
u=g\ &\text{ on }&&\ \partial\mathbb R_+^n.\tag{BC}\label{BC_nonzero}
\end{empheq}
...
\draw[below] (1/4,0) node {$\frac1n$};
\draw (3/4,-0.015) -- (3/4,0.015);
\draw[below] (3/4,0) node {$1-\frac1n$};
\draw[below] (1,0) node {$1$};
%x'=x+r*(cos(a')-cos(a))
%y'=y+r*(sin(a')-sin(a))
\draw ({3/5+1/20*(sqrt(3)/2-1)},1/2*1/20) arc(30:-30:1/20);
\draw ({2/5+1/20*(-sqrt(3)/2+1)},1/2*1/20) arc(150:210:1/20);
...
\draw[below] (2/3*1/6-0.01,0) node {$\lambda\frac1n$};
\draw (1/6,0.01) -- (1/6,-0.01);
\draw[below] (1/6,0) node {$\frac1n$};
\draw (1,0.01) -- (1,-0.01);
\draw[below] (1,0) node {$1$};
\end{tikzpicture}
\end{center}
