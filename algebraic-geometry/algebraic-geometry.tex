...
\begin{tikzpicture}
\draw (-4,-3/2) -- (-4,3/2);
\draw[smooth,samples=200,domain=-3/2:3/2] plot({((\x)^2)^(1/3)},\x);
\draw[->] (-3,0) -- (-1,0);
\end{tikzpicture}
\end{center}
...
\begin{center}
\begin{tikzpicture}
\draw (-5,{-sqrt(2)}) -- (-5,{sqrt(2)});
\draw[smooth,samples=100,domain=-1:1] plot(\x,{sqrt((\x)^(2)+(\x)^(3))});
\draw[smooth,samples=100,domain=-1:1] plot(\x,{-sqrt((\x)^(2)+(\x)^(3))});
\draw[->] (-4,0) -- (-2,0);
\end{tikzpicture}
\end{center}
...
\begin{center}
\begin{tikzpicture}
\draw[smooth,samples=100,domain=-1:3/2] plot({sqrt((\x)^(2)+(\x)^(3))-4},\x);
\draw[smooth,samples=100,domain=-1:3/2] plot({-sqrt((\x)^(2)+(\x)^(3))-4},\x);
\draw [fill] (-4,0) circle (2pt);
\draw[smooth,samples=100,domain=-1.037184:3/2] plot({sqrt((\x)^(2)+(\x)^(3)+1/25)+4},\x);
\draw[smooth,samples=100,domain=-1.037184:3/2] plot({0-sqrt((\x)^(2)+(\x)^(3)+1/25)+4},\x);
\draw [fill] (21/5,0) circle (2pt);
\draw [fill] (19/5,0) circle (2pt);
\draw (5/2,0) -- (11/2,0);
\draw[right] (11/2,0) node {$\mathbb{P}_k^1$};
\draw[->] (3/2,0) -- (-3/2,0);
...
\begin{center}
\begin{tikzpicture}
\draw[smooth,samples=200,domain=-3/2:3/2] plot({((\x)^2)^(1/5)},\x);
\draw (-1,1) node {cusp};
\end{tikzpicture}
\end{center}
\end{enumerate}
...
\draw (-3,3/2) ellipse (1 and {sqrt(3)/3});
\draw[dash pattern=on 4pt off 4pt] ({sqrt(69)/9-3},-23/18) arc (acos(sqrt(69)/9):180-acos(sqrt(69)/9):1 and {sqrt(3)/3});
\draw ({-sqrt(69)/9-3},-23/18) arc (180-acos(sqrt(69)/9):360+acos(sqrt(69)/9):1 and {sqrt(3)/3});
\draw ({-sqrt(69)/9-3},23/18) -- ({sqrt(69)/9-3},-23/18);
\draw ({sqrt(69)/9-3},23/18) -- ({-sqrt(69)/9-3},-23/18);
\draw [fill] (-3,0) circle (2pt);
\draw (3,3/2) ellipse (1 and {sqrt(3)/3});
\draw[dash pattern=on 4pt off 4pt] (4,-3/2) arc (0:180:1 and {sqrt(3)/3});
\draw (2,-3/2) arc (180:360:1 and {sqrt(3)/3});
\draw[dash pattern=on 4pt off 4pt] (4,0) arc (0:180:1 and {sqrt(3)/3});
\draw (2,0) arc (180:360:1 and {sqrt(3)/3});
\draw (2,3/2) -- (2,-3/2);
\draw (4,3/2) -- (4,-3/2);
\draw[->] (4/3,0) -- (-2,0);
\draw[above] (-1/3,0) node {$\pi$};
\draw[->] (47/10,3/5) -- (21/5,1/5);
\draw[above right] (47/10,3/5) node {$\mathbb{P}_k^1$};
\draw[left] (-4,0) node {$A_1$ singularity};
\end{tikzpicture}
\end{center}
\end{exercise}
...
\begin{center}
\begin{tikzpicture}
\draw[smooth,domain=-1:1] plot({sqrt((\x)^2+1)-4},\x);
\draw[smooth,domain=-1:1] plot({-sqrt((\x)^2+1)-4},\x);
\draw[smooth,domain=-2:2] plot(\x-4,{(\x)^2/10});
\draw (-1,3/2) -- (-1,-3/2);
\draw[samples=100,smooth,domain=-1:1/2] plot(\x+1,{sqrt((\x)^2+(\x)^3)});
\draw[samples=100,smooth,domain=-1:1/2] plot(\x+1,{-sqrt((\x)^2+(\x)^3)});
\draw (-3/4+4,0) -- (3/4+4,0);
\draw (4,3/4) -- (4,-3/4);
\draw (-3/4+4,3/4) -- (3/4+4,-3/4);
\draw (-3/4+4,-3/4) -- (3/4+4,3/4);
\draw (12/5,3/2) node {not};
\end{tikzpicture}
\end{center}
